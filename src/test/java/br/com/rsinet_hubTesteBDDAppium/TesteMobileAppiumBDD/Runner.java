...
@CucumberOptions(features = "C:\\Users\\gehaime.silva\\Desktop\\APPIUMBDD\\TesteMobileAppiumBDD\\Features\\Lupa_Test.feature",
		...
		plugin = {"com.cucumber.listener.ExtentCucumberFormatter:C:\\Users\\gehaime.silva\\Pictures\\Appium\\Busca.hmtl"},
     	monochrome = true,
		dryRun = false
...
public class Runner {
	...
	Reporter.loadXMLConfig(new File("C:\\Users\\gehaime.silva\\Desktop\\APPIUMBDD\\TesteMobileAppiumBDD\\pom.xml"));
	}
}